...
g_image_original = cv2.imread(
    "C:/Users/user/Desktop/work/V1.jpg")  # 原始圖片，建議大於視窗寬高（800*600）
...
def mouse(event, x, y, flags, param):
    ...
    # 按住右鍵拖曳
        ...
        if roi != (0, 0, 0, 0):
            ...
            cv2.imwrite("C:/Users/user/Desktop/work/test.jpg", crop)
            print('Saved!')
...
if __name__ == "__main__":
    ...
    cv2.waitKey()  # 不可缺少，用於重新整理圖片，等待滑鼠操作
